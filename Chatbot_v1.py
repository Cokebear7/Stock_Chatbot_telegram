...
TOKEN = "1289979164:AAFIk-cKhHQldcNosysCQ28VAuuF2Gko_3M"
...
policy = {
    (INIT, "greet"): (INIT, "Hi, what can I do for you?", None),
    ...
    (INIT, "exit"): (FINISH, "ok, see you next time!", None),
    ...
    (SEARCH_PRICE, "exit"): (FINISH, "ok, see you next time!", None),
    ...
    (SEARCH_VALUE, "exit"): (FINISH, "ok, see you next time!", None)
}
